...
<head>
    ...
    <title>Print Receipt Additional</title>
...
echo '<img src="data:image/png;base64,' . base64_encode($generator->getBarcode('$adcode', $generator::TYPE_CODE_128)) . '">';
			?>
  </div>
  <div id="date">
			<?php echo "$adcode"; ?>

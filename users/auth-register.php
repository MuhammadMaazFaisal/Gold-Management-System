...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty(trim($_POST["useremail"]))) {
        ...
        $sql = "SELECT `user_id` FROM tbl_user WHERE useremail = ?";
    ...
    if (empty($_POST["roles"])) {
        $roles_err = "Please enter a role.";
    } else {
       $roles = $_POST["roles"]; print_r($roles); die();
    }
    ...
    if (empty($useremail_err) && empty($username_err) && empty($password_err) && empty($confirm_password_err)) {
        ...
        $sql = "INSERT INTO tbl_user (useremail, username, password, token) VALUES (?, ?, ?, ?)";
...
<head>
    ...
    <title>Register User | XML - Workflow System</title>
                        ...
                        <div class="d-flex flex-column h-100">
                            <div class="mb-4 mb-md-5 text-center">
                                <a href="index.php" class="d-block auth-logo">
                                    <img src="assets/images/logo-sm.svg" alt="" height="28"> <span class="logo-txt">XML Work FLow System</span>
                                </a>
                            </div>
                            <div class="auth-content my-auto">
                                <div class="text-center">
                                    <h5 class="mb-0">Register New User Account</h5>
                                        ...
                                        <div class="carousel-item">
                                            <div class="testi-contain text-white">
                                                ...
                                                <h4 class="mt-4 fw-medium lh-base text-white">“I've learned that
                                                    ...
                                                    how in difficult times, you made them
                                                    feel.”</h4>
                                                <div class="mt-4 pt-3 pb-5">
                                                    <!-- <div class="d-flex align-items-start">

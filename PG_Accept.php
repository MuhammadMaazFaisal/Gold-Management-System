    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="page-title mb-0 font-size-18">ACCEPT ARTICLE</h4>
...
//  $sql3="SELECT UserAssignedArticles.UserAssignedArticleID FROM UserAssignedArticles WHERE UserID = 4 AND ArticleID = 11 AND ProcessingStageID = 4;";
//  $stmt3= $pdo->prepare($sql3);
//  $stmt3->bindParam(":uaaid",$uaa_id);
//  $stmt3->execute();
//  if($stmt3->rowCount()==1){
//     $row3= $stmt3->fetch();
//     $user_assigned_article = $row3["UserAssignedArticleID"];
//  }
...
<form class="custom-validation" action="PG_Accept_db.php" method="post"> 
...
<input id="id" name="id" type="hidden" value="<?php echo $_GET['id']; ?>">
                   ...
                   <input id="psid" name="ps_id" type="hidden" value="<?php echo $ps_id; ?>">
                                ...
                                <br>
                       <div>
                       <p>Are you sure you want to accept article? </p>

                           <button type="submit" class="btn btn-info waves-effect waves-light">
                               ACCEPT
                           </button>
                           <a class="btn btn-secondary waves-effect" href="PG-Dashboard-User.php">BACK</span></a>

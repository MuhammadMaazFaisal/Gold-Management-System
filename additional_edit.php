...
<div id="layout-wrapper">
    ...
    $date= $name=  $type= $amount= $additionalbarcode="";
 
echo $id =  trim($_GET["id"]);

    $sql="SELECT * FROM additional_step WHERE id  = $id";
    ...
    if($stmt->rowCount() == 1){
        ...
        $type= $row["type"];
		$amount= $row["amount"];
		$additionalbarcode= $row["additionalbarcode"];
       ...
       <div class="page-content">
                            ...
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="page-title mb-0 font-size-18">EDIT ADDITIONAL ACTIVITY</h4>
    								<!--
                        ...
                        <div class="col-lg-11">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="custom-validation" action="additional_edit_db.php" method="post" enctype="multipart/form-data"> 

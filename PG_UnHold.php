    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="page-title mb-0 font-size-18">UNHOLD ARTICLE</h4>
...
<form class="custom-validation" action="PG_UnHold_db.php" method="post"> 
...
<input id="id" name="id" type="hidden" value="<?php echo $_GET['id']; ?>">
                   ...
                   <input id="psid" name="ps_id" type="hidden" value="<?php echo $ps_id; ?>">
                                ...
                                <br>
                       <div>
                       <p>Are you sure you want to unhold article? </p>

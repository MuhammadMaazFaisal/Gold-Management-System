       ...
       <div class="page-content">
                            ...
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="page-title mb-0 font-size-18">ADD PROCESSING STAGE</h4>
    								<!--
                    ...
                    <div class="row">
                       ...
                       ?>
                                    <form class="custom-validation" action="UM_processing-stage_add_db.php" method="post" enctype="multipart/form-data"> 
         ...
         <br>
                                        ...
                                        <div class="form-group mb-0">
                                            <div>
                                                ...
                                                <a type="reset" class="btn btn-secondary waves-effect" href="UM_processing-stage.php">
                                                    Cancel
</a>
                                            </div>
                                        </div>

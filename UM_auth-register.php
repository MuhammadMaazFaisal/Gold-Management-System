                        ...
                        <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="mb-3 <?php echo (!empty($confirm_password_err)) ? 'has-error' : ''; ?>">
                                        ...
                                        <select class="form-control" data-trigger name="roles[]" id="choices-multiple-default" placeholder="This is a placeholder" multiple>
                                            <?php foreach ($roles as $output) { ?>
                                                <option value="<?php echo $output["RoleID"]; ?>"> <?php echo $output["RoleName"]; ?> </option>
                                            <?php
                                            } ?>
                            ...
                            <div class="mt-4 mt-md-5 text-center">
                                <p class="mb-0">© <script>
                                    ...
                                    </script>Developed by <a href="http://esolacetech.com/" target="_blank" style="color: #cd71f5;"><b>Esolace Tech</b>.</a>.</a></p>
                            </div>
                        </div>
                    </div>
                </div>

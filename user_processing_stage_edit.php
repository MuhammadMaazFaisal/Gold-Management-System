            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="page-title mb-0 font-size-18">SELECT PROCESSING STAGES FOR USER</h4>
                        <!--
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="custom-validation" action="user_processing_stage_edit_db.php" method="post" enctype="multipart/form-data">

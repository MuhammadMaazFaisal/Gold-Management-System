...
<head>
    ...
    <title>Edit Manufecturing</title>
...
<div id="layout-wrapper">
    ...
    $date= $name=  $image= $details= $type= $quantity= $purity= $unpolish_weight= $polish_weight= $rate= $wastage= $unpure_weight= $pure_weight= $tValues= $code ="";
       ...
       <div class="page-content">
                            ...
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="page-title mb-0 font-size-18">EDIT MANUFECTURING ACTIVITY</h4>
    								<!--
                        ...
                        <div class="col-lg-11">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="custom-validation" action="manufecturing_edit_db.php" method="post" enctype="multipart/form-data"> 
          ...
          <div class="form-group ">
              <label>Unpolish Weight</label>
              <input type="text" name="unpolish_weight" class="form-control" value="<?php echo $unpolish_weight; ?>"required>
           
          </div>
		  <div class="form-group ">
              <label>Polish Weight</label>
              <input type="text" name="polish_weight" class="form-control" value="<?php echo $polish_weight; ?>"required>
		  ...
		  <div class="form-group">
              <label>24K</label>
              <input type="text" name="tValues" class="form-control" value="<?php echo $tValues; ?>"required>

...
<head>
    <title>Dashboard | <?php echo $language["Dashboard"]; ?></title>
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col-6">
                                                ...
                                                <h4 class="mb-3">
                                                    <span class="counter-value" data-target="<?php echo $roles;?>">0</span>
                                                </h4>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col-6">
                                                ...
                                                <h4 class="mb-3">
                                                    <span class="counter-value" data-target="<?php echo $nsc;?>">0</span>
                                                </h4>
                                            </div>
                                            <div class="col-6">
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col-6">
                                                ...
                                                <h4 class="mb-3">
                                                    <span class="counter-value" data-target="<?php echo $unactiveuser;?>">0</span>
                                                </h4>
                                            </div>
                                            <div class="col-6">
                                                <div id="mini-chart2" data-colors='["#5156be"]' class="apex-charts mb-2"></div>
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col-6">
                                                ...
                                                <h4 class="mb-3">
                                                    <span class="counter-value" data-target="<?php echo $system_activities;?>">0</span>
                                                </h4>
                                            </div>
                                            <div class="col-6">
                                                <div id="mini-chart2" data-colors='["#5156be"]' class="apex-charts mb-2"></div>
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col-6">
                                                ...
                                                <h4 class="mb-3">
                                                    <span class="counter-value" data-target="<?php echo $manufacturing_step;?>">0</span>
                                                </h4>
                                            </div>
                                            <div class="col-6">
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col-6">
                                                ...
                                                <h4 class="mb-3">
                                                    <span class="counter-value" data-target="<?php echo $polisher_step;?>">0</span>
                                                </h4>
                                            </div>
                                            <div class="col-6">
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col-10">
                                                ...
                                                <h4 class="mb-3">
                                                    <span class="counter-value" data-target="<?php echo $additional;?>">0</span>
                                                </h4>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col-6">
                                                ...
                                                <h4 class="mb-3">
                                                    <span class="counter-value" data-target="<?php echo $gold_accont_step;?>">0</span>
                                                </h4>
                                            </div>
                                            <div class="col-6">
                                                <div id="mini-chart4" data-colors='["#5156be"]' class="apex-charts mb-2"></div>
                            ...
                            <div class="col-lg-4">
                                <div class="card bg-dark border-dark text-light">
                                    <div class="card-body">
                                        ...
                                        <h3 class="mb-4 text-light"><?php echo $supplier_list;?></h3>
                                    </div>
                                </div>
                            </div><!-- end col -->
                            ...
                            <div class="col-lg-4">
                                <div class="card bg-success border-success text-white-50">
                                    <div class="card-body">
                                        ...
                                        <h3 class="mb-4 text-light"><?php echo $purchase_order_list;?></h3>
                                    </div>
                                </div>
                            </div><!-- end col -->
                            ...
                            <div class="col-lg-4">
                                <div class="card bg-info border-info text-white-50">
                                    <div class="card-body">
                                        ...
                                        <h3 class="mb-4 text-light"><?php echo $item_list;?></h3>
                                    </div>
                                </div>
                            </div><!-- end col -->

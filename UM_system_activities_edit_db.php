...
{     $id= trim($_POST["id"]);
    ...
    //   $system_activities_code = trim($_POST["system_activities_code"]);
      $system_activities_description = trim($_POST["system_activities_description"]);
   ...
   <?php //exit(); //} 
    ...
    $update_query = "UPDATE SystemActivities SET SystemActivityDescription=:system_activities_description  WHERE SystemActivityID=$id";
    ...
    //   $update_stmt->bindParam(":system_activities_code", $param_system_activities_code);
      $update_stmt->bindParam(":system_activities_description", $param_system_activities_description);
    ...
    //   $update_stmt->bindParam(":added_by", $param_added_by);
      ...
      $param_system_activities_description = $system_activities_description;

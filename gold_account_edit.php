...
echo $id =  trim($_GET["id"]);
    ...
    $sql="SELECT * FROM goldaccount WHERE AccID  = $id";
    ...
    <div class="main-content">
       ...
       <div class="page-content">
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="custom-validation" action="gold_account_edit_db.php" method="post" enctype="multipart/form-data"> 
          ...
          <div class="form-group ">
              ...
              <input type="text" name="gold_issued" class="form-control" value="<?php echo $gold_issued; ?>"required>

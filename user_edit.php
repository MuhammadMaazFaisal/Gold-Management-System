    ...
    <div class="main-content">
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="page-title mb-0 font-size-18">SELECT ROLE FOR USER</h4>
                        <!--
            ...
            <div class="row">
                ...
                $stmt = $pdo->prepare("SELECT RoleID, RoleName  FROM Roles");
                $stmt->execute();
                $row2 = $stmt->fetchAll();
                ?>
                            ...
                            <form class="custom-validation" action="user_edit_db.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3 <?php echo (!empty($confirm_password_err)) ? 'has-error' : ''; ?>">
                                        ...
                                        <select class="form-control" data-trigger name="roles[]" id="choices-multiple-default" placeholder="This is a placeholder" multiple>
                                            <?php foreach ($row as $output) { ?>
                                                <option value="<?php echo $output['RoleID']; ?>" <?php echo ' selected="selected"'; ?>> <?php echo $output['RoleName']; ?>
                                                </option>
                                            <?php
                                            } ?>
                                ...
                                <div class="form-group mb-0">
                                    <div>
                                        ...
                                        <a href="UM_users.php" type="reset" class="btn btn-secondary waves-effect">
                                            Cancel
                                        </a>
                                    </div>
                                </div>

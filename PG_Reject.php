    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="page-title mb-0 font-size-18">REJECT ARTICLE</h4>
...
<form class="custom-validation" action="PG_Reject_db.php" method="post"> 
...
<input id="id" name="id" type="hidden" value="<?php echo $_GET['id']; ?>">
                   ...
                   <input id="psid" name="ps_id" type="hidden" value="<?php echo $ps_id; ?>">
                                ...
                                <!-- <div>
                                    <div class="form-group">
                                        <label>Why you want to reject this article ? *</label>
                                        <textarea name="comment" class="form-control" value= "<?php echo $comment; ?>"required></textarea>
                                    </div>
                                </div> -->
                                
                                <br>
                       <div>
                       <p>Are you sure you want to reject article? </p>

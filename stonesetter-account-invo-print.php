...
<head>
    ...
    <title>Print Stone Setter Account Receipt </title>
...
echo '<img src="data:image/png;base64,' . base64_encode($generator->getBarcode('$ssacode', $generator::TYPE_CODE_128)) . '">';
			?>
  </div>

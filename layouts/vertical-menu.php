            ...
            <ul class="metismenu list-unstyled" id="side-menu">
				...
				<?php if (isset($_SESSION['Super Admin'])) { ?>
				    ...
				    <li>
                        ...
                        <li>
                        <a href="UM_system_activities.php" class=" ">
				...
				<?php if (isset($_SESSION['prodp']) || isset($_SESSION['Super Admin'])) { ?>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
							...
							<li><a href="view_manufecturing.php" data-key="t-register">View Details</a></li>
                        </ul>
				...
				<?php if (isset($_SESSION['Super Admin'])) { ?>
                   ...
                   <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
							...
							<li><a href="#" data-key="t-register">Return List</a></li>
							<li><a href="#" data-key="t-register">Stocks</a></li>
							<li><a href="#" data-key="t-register">Supplier List</a></li>
							<li><a href="#" data-key="t-register">Item List</a></li> -->
                        </ul>
               ...
               <!-- <li class="menu-title" data-key="t-menu"><?php echo $language["Menu"]; ?></li>
                ...
                <!-- <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="auth-add-roles.php" data-key="t-login">Add Roles</a></li>

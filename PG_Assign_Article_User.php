...
// $ar_id=2;
// $ast_id=1;
echo $ps_id =  trim($_GET["psid"]);
echo $ar_id =  trim($_GET["arid"]);
echo $ast_id =  trim($_GET["astid"]);
...
//Already existing user according to processing stages
...
?>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <form class="custom-validation" action="PG_Assign_Article_User_db.php" method="post" enctype="multipart/form-data">
                                <div class="form-group ">
                                    ...
                                    <input type="text" name="processingstagename" class="form-control" readonly value="<?php 
                                    echo $processingstagename; ?>" required>
                                </div>
                                <div class="form-group ">
                                    <label>Article Code</label>
                                    <input type="text" name="articlecode" class="form-control" readonly value="<?php echo 
                                    $articlecode; ?>" required>
                                </div>
                                <div class="form-group ">
                                    <label>Assignment Type</label>
                                    <input type="text" name="assignmenttype" class="form-control" readonly value="<?php echo $assignmenttype;
                                     ?>" required>
                               ...
                               <?php 
                                ...
                                <div class="form-group mb-0">
                                    <div>
                                        ...
                                        <a type="reset" class="btn btn-secondary waves-effect" href="PG-Dashboard-User.php">
                                            Cancel
                                        </a>
                                    </div>
                                </div>

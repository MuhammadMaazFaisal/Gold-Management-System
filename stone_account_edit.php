...
<head>
    ...
    <title>Edit Stone Setter Account</title>
...
echo $id =  trim($_GET["id"]);
    ...
    $sql="SELECT * FROM stone_setter_account WHERE ssaID = $id";
       ...
       <div class="page-content">
                            ...
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="page-title mb-0 font-size-18">EDIT STONE ACTIVITY</h4>
    								<!--
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="custom-validation" action="stone_account_edit_db.php" method="post" enctype="multipart/form-data"> 
          ...
          <div class="form-group ">
              <label>Gold Rreceived *</label>
              <input type="text" name="received" class="form-control" value="<?php echo $received; ?>"required>

...
echo $id =  trim($_GET["id"]);
    ...
    $sql="SELECT * FROM cashaccount WHERE caID  = $id";
       ...
       <div class="page-content">
                            ...
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="page-title mb-0 font-size-18">EDIT CASH ACTIVITY</h4>
    								<!--
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="custom-validation" action="cash_account_edit_db.php" method="post" enctype="multipart/form-data"> 
